...
public class Expense {
    ...
    @JoinColumn(name = "recurring_expense_id", updatable = false)
    ...
    public Expense(ExpenseGroup group, User paidBy, BigDecimal amount, String description, LocalDate expenseDate) {
        this(group, paidBy, amount, description, expenseDate, null);
    }

    // AC3: links an expense generated by the recurring-expense scheduler back to its source
    public Expense(ExpenseGroup group, User paidBy, BigDecimal amount, String description, LocalDate expenseDate,
